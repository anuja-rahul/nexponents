...
export default function NotFoundSection( {className}: NotFoundSectionProps) {
  return (
    <div className={clsx("h-screen", className)}>
      <DynamicBreadCrumbs name={"404"} className="h-1/5" />
      <div className="flex flex-col items-center justify-center w-full h-3/5 gap-3">
