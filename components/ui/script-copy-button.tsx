...
export function ScriptCopyBtn({
  ...
  return (
    <div
      className={cn(
        "mx-auto flex max-w-auto items-start justify-start",
        className
      )}
    >
      <div className="w-full space-y-2">
        <div className="mb-2 flex items-center justify-between">
          {showMultiplePackageOptions && (
            <div className="relative">
              <div className="inline-flex overflow-hidden rounded-md border-none text-xs">
        ...
        <div className="relative flex items-center">
          ...
          <Button
            variant="outline"
            size="icon"
            className="relative ml-2 rounded-xl bg-slate-950 text-white hover:bg-slate-800/80 border-none hover:text-white"
