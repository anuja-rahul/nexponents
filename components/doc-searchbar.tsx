export default function DocSearchBar() {
  return (
    <div className="max-w-60 w-fit h-8 border-[1.5px] border-foreground/30 bg-background/70 rounded-lg flex flex-row flex-nowrap items-center justify-between px-4 opacity-70 hover:opacity-100 transition-opacity duration-200">
